package com.lihengl.jujutsu.listeners;
...
public abstract class InfiniteScrollListener implements OnScrollListener {
	...
	// This happens many times a second durring a scroll, so be wary of the code
	// you place here. We are given a few useful parameters to help us work out
	// if we need to load some more data, but first we check if we are waiting
